...
export function LiveScoreCard({
  ...
  return (
    <section
      ...
      aria-label={
        finished
          ? `Partido finalizado contra ${match.versus}`
          : `Partido en vivo contra ${match.versus}`
      }
    >
        ...
        <div className="bg-primary/5 px-4 py-3">
          <div className="grid grid-cols-3 items-center gap-3">
            ...
            <div className="text-center">
              <span
                className={`font-display inline-block px-3 py-1 rounded-lg text-sm font-bold uppercase ${
                  finished
              ...
              >
                <span
                  aria-hidden="true"
                  className={finished ? "hidden" : "inline-flex w-2 h-2 mr-1.5 rounded-full bg-red-500 animate-pulse align-middle"}
                />
                {finished
                  ? "Finalizado"
                  : "En vivo"}
              </span>
              {!finished && live.minute && (
              ...
              <div className={!finished && live.minute ? "mt-1" : "mt-1.5"}>
          ...
          <div className="flex items-center justify-center gap-2 text-sm text-muted flex-wrap mt-2">
            <span className="inline-flex items-center gap-0.5">
              ...
              <span className="font-medium">
                {formattedDate.date} — {formattedDate.time} hs.
              </span>
            </span>
            <span className="inline-flex items-center gap-0.5">
